...
@NgModule({
    declarations: [ HotelListComponent, HotelCardComponent, HotelStarsFilterComponent, HotelValueFilterComponent ],
    imports: [ CommonModule ],
    exports: [ HotelListComponent, HotelCardComponent, HotelStarsFilterComponent, HotelValueFilterComponent ],
